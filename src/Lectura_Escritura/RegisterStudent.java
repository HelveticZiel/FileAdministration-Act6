...
public class RegisterStudent {
    ...
    BufferedWriter bw = new BufferedWriter(fw);
        ...
        //No lo puedo "abrir y cerrar" como si fuese un Scanner? Queda por revisar
            //NOP. Tendria que crear otro BufferedWriter y FileWriter o en todo caso, escribir la la nueva linea antes de cerrar  el otro
                  ...
                  //      } 
                    ...
                    case 2:
                        ...
                        for(String linea=br1.readLine(); linea != null ; linea = br1.readLine()){
                           ...
                           // System.out.println(Arrays.toString(linea.split(";"))); Asi printea pero un poco guarrete creo yo
                                       
                           for(String trozo : trozos){ //ES un for-each
